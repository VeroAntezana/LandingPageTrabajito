...
import "./styles/MeetingScheduled.css";

export default function MeetingScheduled() {
  return (
    <div className="meeting-scheduled-container">
      <div className="meeting-style">
        <div className="confirmation-message">
          <h1>Reunión agendada exitosamente!</h1>
          ...
          <p>
            En un momento recibirás el link de la reunión en el correo
            electrónico que proporcionaste
          </p>
        </div>
        <button className="understood-button">Entendido</button>
      </div>
    </div>
  );
}
